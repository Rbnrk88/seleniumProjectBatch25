...
public class T4_FramePractice {
    ...
    public void alert_test1(){
        ...
        //option #1 switching to iframe using nid attribute value
        //driver.switchTo().frame("mce_0_ifr");

        //option #2- passing index number of iframes
        ...
        //To be able to verify the header, we must be switch back to "main HTML
